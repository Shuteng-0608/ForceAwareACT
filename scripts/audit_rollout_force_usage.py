...
def run_audit(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if adapter.kind != ACT_ALIGNED_ROLLOUT_KIND:
        raise ValueError("force-usage audit requires an ACT-aligned Contact-CVAE checkpoint")
    ...
    return {
        "audit_version": "rollout_force_intervention_v1",
        ...
        "input_shapes": {
            ...
            "force_history": (1, adapter.force_window_len, adapter.config.force_dim),
        },
